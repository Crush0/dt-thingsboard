...
--
-- GOVIEW SQL START
CREATE INDEX IF NOT EXISTS idx_goview_project_tenant_id ON goview_project(tenant_id);
CREATE INDEX IF NOT EXISTS idx_goview_project_name ON goview_project(tenant_id, name);

CREATE INDEX IF NOT EXISTS idx_goview_project_data_tenant_id ON goview_project_data(tenant_id);
CREATE INDEX IF NOT EXISTS idx_goview_project_data_project_id ON goview_project_data(tenant_id, project_id);

CREATE INDEX IF NOT EXISTS idx_goview_file_tenant_id ON goview_file(tenant_id);
CREATE INDEX IF NOT EXISTS idx_goview_file_name ON goview_file(tenant_id, name);
CREATE INDEX IF NOT EXISTS idx_goview_file_virtual_key ON goview_file(tenant_id, virtual_key);
-- GOVIEW SQL END
