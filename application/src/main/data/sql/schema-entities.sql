...
--
-- GOVIEW SQL START
CREATE TABLE IF NOT EXISTS goview_project
(
    id uuid NOT NULL CONSTRAINT goview_project_pkey PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS goview_project_data
(
    id uuid NOT NULL CONSTRAINT goview_project_data_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
    tenant_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS goview_file
(
    id uuid NOT NULL CONSTRAINT goview_file_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
    tenant_id uuid NOT NULL,
    name varchar(255) NOT NULL,
...
-- GOVIEW SQL END-- GOVIEW SQL START
CREATE TABLE IF NOT EXISTS goview_project
(
    id uuid NOT NULL CONSTRAINT goview_project_pkey PRIMARY KEY,
    created_time bigint NOT NULL,
